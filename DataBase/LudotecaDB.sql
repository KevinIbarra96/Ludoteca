...
CREATE TABLE IF NOT EXISTS `hijos` (
  ...
  CONSTRAINT `fk_Hijo_Mama` FOREIGN KEY (`Mama`) REFERENCES `padres` (`idPadres`),
  CONSTRAINT `fk_Hijo_Papa` FOREIGN KEY (`Papa`) REFERENCES `padres` (`idPadres`) ON UPDATE SET NULL
...
CREATE TABLE IF NOT EXISTS `visitas` (
  ...
  CONSTRAINT `fk_Visita_Hijo` FOREIGN KEY (`Hijo`) REFERENCES `hijos` (`idHijos`),
  CONSTRAINT `fk_Visita_Oferta` FOREIGN KEY (`Oferta`) REFERENCES `ofertas` (`idOfertas`),
  CONSTRAINT `fk_Visita_Servicio` FOREIGN KEY (`Servicio`) REFERENCES `servicios` (`idServicios`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
