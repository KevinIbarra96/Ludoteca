...
namespace Data
{
    ...
    {
        private static string _apiPath = ApiRest_Properties.cliente.BaseAddress + "/Padre"; //Adding ControllerName to Path
        private static List<EN_Padre> PadresResponse = null;

        public static async Task<List<EN_Padre>> getAllPadres()
        {
            PadresResponse = null;
            string _enPoint = _apiPath + "/getAllPadres"; //Adding endpoint to path
